...
// What you will learn
// Slides. Real life examples. Problem -> solution.
// Simple example of generic and tuple
// Don't scroll. Split files into smaller chunks of code
// Add into to every problem
// Create one slide for compiled code in unions
